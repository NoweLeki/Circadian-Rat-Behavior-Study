...
day_categories = ['Days_1_3', 'Days_4_6']
time_phases = ['Dark', 'Light'] # morning 20240525
...
def save_heatmap(data, column, filename):
    ...
    if column != "DUMMY":
        ...
        fig.text(0.25, 0.03, 'Dark', ha='center', fontsize=16) # morning
        fig.text(0.75, 0.03, 'Light', ha='center', fontsize=16)
...
# 32.208-PLOTS-co-occurrences-heatmaps-morning-python-GT-36 Excel !-AGGREGATE-contact sheet-NORMALIZED.py
