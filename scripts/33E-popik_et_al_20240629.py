...
light_cmap = LinearSegmentedColormap.from_list("light", ["#ffffd9", "#ff7f0e"])  # Yellow to orange
dark_cmap = LinearSegmentedColormap.from_list("dark", ["#1f77b4", "#08306b"])    # Blue to dark blue
...
# 32.215-DARKER-evening-co-occ-several-based on CSV - just-plot-3d-sequence analysis co-occurrence-python-GT-36.py
